...
export function Footer() {
  ...
  const whatsapp = datiAziendali?.whatsapp || "+393331234567"
  ...
  return (
    <footer className="bg-[#1e5a5a] text-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <Link 
              href="/" 
              className="text-lg font-medium tracking-[0.15em] block mb-4"
              style={{ fontFamily: "var(--font-dm-sans)" }}
            >
              SOLAIR GROUP
            </Link>
            <p className="text-sm text-white/70 font-light leading-relaxed" style={{ fontFamily: "var(--font-dm-sans)" }}>
          ...
          {/* Navigation Links */}
          <div>
            <h4 className="text-sm font-medium tracking-wide mb-4 text-white/90" style={{ fontFamily: "var(--font-dm-sans)" }}>
              NAVIGAZIONE
            </h4>
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-white/50" style={{ fontFamily: "var(--font-dm-sans)" }}>
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href="/terms" className="text-xs text-white/50 hover:text-white/80 transition-colors" style={{ fontFamily: "var(--font-dm-sans)" }}>
                Terms
              </Link>
              <a 
