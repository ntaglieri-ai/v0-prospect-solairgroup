      ...
      <div className="w-full grid lg:grid-cols-2 relative z-10">
        ...
        <div className="flex items-center py-[100px] px-8 lg:px-20 md:bg-[#E8E8E8]">
          <div className="max-w-lg">
            <p className="overline text-[#F5F5F0]/70 md:text-[#6B6B6B] mb-4">
              Chi Siamo
            </p>

            <h2 className="font-heading text-[#F5F5F0] md:text-[#0A0A0A] mb-6">
              L&apos;energia pulita, finalmente accessibile
            </h2>

            <p className="body-text text-[#F5F5F0]/85 md:text-[#6B6B6B] mb-10">
            ...
            <div className="flex items-center gap-0 pt-8 border-t border-[#F5F5F0]/20 md:border-[#E8E8E8]">
              <div className="pr-8">
                <p className="font-heading text-[2.5rem] text-[#F5F5F0] md:text-[#0A0A0A]">500+</p>
                <p className="overline text-[#F5F5F0]/70 md:text-[#6B6B6B] mt-1">Impianti</p>
              </div>
              <div className="border-l border-[#F5F5F0]/20 md:border-[#E8E8E8] px-8">
                <p className="font-heading text-[2.5rem] text-[#F5F5F0] md:text-[#0A0A0A]">4</p>
                <p className="overline text-[#F5F5F0]/70 md:text-[#6B6B6B] mt-1">Sedi</p>
              </div>
              <div className="border-l border-[#F5F5F0]/20 md:border-[#E8E8E8] pl-8">
                <p className="font-heading text-[2.5rem] text-[#F5F5F0] md:text-[#0A0A0A]">98%</p>
                <p className="overline text-[#F5F5F0]/70 md:text-[#6B6B6B] mt-1">Soddisfatti</p>
              </div>
            </div>
          </div>
        </div>
