    ...
    <section id="recensioni" className="relative py-10 sm:py-16 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center mb-10 sm:mb-16">
          <p className="text-sm font-semibold uppercase tracking-widest text-[#2e8b72] mb-3">
            TESTIMONIANZE
          </p>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1e3a5f] tracking-tight px-2 mb-6">
