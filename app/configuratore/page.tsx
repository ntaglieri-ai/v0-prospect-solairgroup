          ...
          <div>
            ...
            <div style={{ background: "#fffbf0", border: "1px solid rgba(245,158,11,0.4)", borderLeft: "3px solid #f59e0b", borderRadius: 12, padding: "16px 18px", marginBottom: 16 }}>
              ...
              <label style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10, cursor: "pointer" }}>
                ...
                <span style={{ fontSize: 12, color: "#333", lineHeight: 1.5 }}>Dichiaro di aver letto e accettato le <a href="https://blobs.vusercontent.net/blob/condizioni-generali-solair-bQ3RPdg7J7ifX1MmHBiMam586xTVTq.pdf" target="_blank" rel="noopener noreferrer" style={{ color: "#1e3a5f", textDecoration: "underline" }}>condizioni generali di vendita e i termini e condizioni</a> di Solair Group.</span>
              </label>
              <label style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10, cursor: "pointer" }}>
