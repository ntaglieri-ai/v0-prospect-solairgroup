...
export const pannello = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'nome',
      title: 'Nome visualizzato (configuratore)',
      type: 'string',
      description: 'Es. "LONGi Hi-MO X10 Explorer" — usato come label nelle card del configuratore',
    ...
    defineField({
      name: 'tags',
      title: 'Tag tecnologici',
      type: 'array',
      of: [{ type: 'string' }],
      description: 'Es. N-type TOPCon, Bifacciale, Full Black…',
      options: { layout: 'tags' },
    }),
